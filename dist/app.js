...
var ajax = new XMLHttpRequest(); // open('데이터를 가져오는 방식: GET or POST', '가져올 데이터 주소', 비동기 통신 여부: true or false ...)

ajax.open('GET', 'https://api.hnpwa.com/v0/news/1.json', false); // send() 함수: 실질적으로 데이터를 가져옴
